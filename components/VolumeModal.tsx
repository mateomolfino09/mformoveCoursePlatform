...
const VolumeModal = () => {
  ...
  return (
    <div className={` z-[100] bg-almost-black  w-full h-screen top-0 ${snap.volumeModal ? 'absolute' : 'hidden'}`}>
        <div className='flex justify-center w-full h-full items-center flex-col  relative bottom-6'>
            <h1 className='text-white text-4xl font-semibold mb-6'>ATENCIÓN</h1>
