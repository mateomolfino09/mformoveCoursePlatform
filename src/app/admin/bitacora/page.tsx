...
import { AdminPage, AdminPageHeader, AdminNavGrid, AdminPageSkeleton, AdminCard } from '../../../components/admin';
  ...
  return (
    <AdmimDashboardLayout>
      ...
      <AdminPage>
        ...
        />
        <AdminCard className="mt-6" padding="md">
          <p className="text-[12px] leading-relaxed text-[var(--admin-muted)]">
            Cada camino contiene 4 semanas (video, audio y texto). El contenido se publica cada lunes
            según las fechas configuradas. Es la característica principal de retención para miembros de
            Cuerpo autónomo.
          </p>
        </AdminCard>
      </AdminPage>
