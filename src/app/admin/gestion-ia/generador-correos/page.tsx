        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
          ...
          <div className="space-y-4">
            ...
            <AdminNavGrid
              columns={1}
              items={[
                { href: '/admin/gestion-ia/marca-voz', title: 'Configurar voz', description: 'Voz de marca para emails' },
                { href: '/admin/gestion-ia/instagram', title: 'Analizar Instagram', description: 'Fuente de tono y contenido' },
              ]}
            />
          </div>
        </div>
