    ...
    <AdmimDashboardLayout>
      ...
      <AdminPage>
        ...
        <AdminNavGrid
          columns={2}
          items={[
            { href: '/admin/memberships/classes/createClass', title: 'Crear clase', icon: PlusCircleIcon },
            { href: '/admin/memberships/classes/createClassType', title: 'Crear filtro', icon: AdjustmentsHorizontalIcon },
            { href: '/admin/memberships/classes/allClasses', title: 'Ver todas', icon: BookOpenIcon },
          ]}
        />
      </AdminPage>
    </AdmimDashboardLayout>
