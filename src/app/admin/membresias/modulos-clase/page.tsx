...
export default function ClassModulesAdminPage() {
  ...
  useEffect(() => {
    if (!Cookies.get('userToken')) router.push('/iniciar-sesion');
    if (auth.user && auth.user.rol !== 'Admin') router.push('/iniciar-sesion');
  }, [auth.user, router]);
  ...
  return (
    <AdmimDashboardLayout>
      <div className="w-full max-w-4xl mx-auto px-4 py-8">
        <Link href="/admin/membresias" className="inline-flex items-center gap-2 text-gray-600 hover:text-gray-900 mb-6 font-montserrat">
        ...
        <div className="flex flex-wrap gap-2 justify-between items-center mb-8">
          ...
          <div className="flex flex-wrap gap-2">
            <Link
              href="/admin/membresias/modulos-clase/crear"
            ...
            <Link
              href="/admin/membresias/submodulos/crear-clase"
            ...
            <Link
              href="/admin/membresias/submodulos/crear"
                ...
                <div key={m._id} className="bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm">
                  <div className="flex items-center justify-between px-6 py-4 bg-gray-50 border-b border-gray-200">
                    ...
                    <div className="flex items-center gap-2">
                      <Link
                        href={`/admin/membresias/modulos-clase/${m._id}/editar`}
                    ...
                    {submodules.length === 0 ? (
                      <div className="border border-gray-100 rounded-lg overflow-hidden">
                        <div className="flex items-center justify-between px-4 py-2 bg-gray-50">
                          ...
                          <Link
                            href={`/admin/membresias/submodulos/${m._id}/${encodeURIComponent(NO_SUBMODULE_SLUG)}`}
                            className="inline-flex items-center gap-1 text-[#4F7CCF] hover:underline font-montserrat text-sm"
                          >
                          ...
                          return (
                            <li key={idx} className="border border-gray-100 rounded-lg overflow-hidden">
                              <div className="flex items-center justify-between px-4 py-2 bg-gray-50">
                                ...
                                <div className="flex items-center gap-2">
                                  <Link
                                    href={`/admin/membresias/submodulos/${m._id}/${encodeURIComponent(slug)}`}
                                    className="inline-flex items-center gap-1 text-[#4F7CCF] hover:underline font-montserrat text-sm"
                                  >
                                    <VideoCameraIcon className="w-4 h-4" />
                                    Gestionar
