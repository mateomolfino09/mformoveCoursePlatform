...
export default function CreateModuleClassPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push(`/admin/membresias/submodulos/${moduleId}/${encodeURIComponent(slug)}`);
    } catch (err: any) {
  ...
  return (
    <AdmimDashboardLayout>
      <div className="w-full max-w-xl mx-auto px-4 py-8">
        <Link href="/admin/membresias/submodulos" className="inline-flex items-center gap-2 text-gray-600 hover:text-gray-900 mb-6 font-montserrat">
