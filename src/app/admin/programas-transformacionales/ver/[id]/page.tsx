...
const ViewProgramPage = () => {
  ...
  const triggerAutomation = async () => {
    try {
      const response = await fetch('/api/eventos/automate-transformational-program', {
        method: 'POST',
        headers: {
      ...
      <div className='bg-gray-700 w-full md:h-[100vh] p-6'>
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex space-x-3">
            ...
            <button
              onClick={() => router.push('/admin/programas-transformacionales')}
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-gray-600 rounded-lg p-6">
              ...
              <div className="space-y-3">
                <button
                  onClick={() => router.push(`/admin/programas-transformacionales/participantes`)}
                ...
                <button
                  onClick={() => router.push(`/admin/programas-transformacionales/analitica`)}
                ...
                <button
                  onClick={() => router.push(`/admin/programas-transformacionales/automatizacion`)}
