  ...
  try {
    ...
    if (!bitacoraBase) {
      return NextResponse.json(
        { error: 'Camino base no encontrada' },
        { status: 404 }
      );
    }

    // Mapear los videos de la camino base al formato esperado
    ...
    console.error('Error obteniendo camino base:', error);
    return NextResponse.json(
