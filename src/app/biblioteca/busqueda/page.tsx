...
export default function Page({ params }: { params: { busqueda: string } }) {
  const { busqueda: search } = params;
  ...
  if (isLoading) {
    return <div> <MiniLoadingSpinner /></div>; // Puedes reemplazar este mensaje por un spinner
  }
