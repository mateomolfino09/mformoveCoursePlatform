                    ...
                    <div className="flex flex-col sm:flex-row gap-3 pt-1 w-full justify-center">
                      <button
                        ...
                        onClick={() => {
                          ...
                          setShowWarmUpModal(false);
                          if (targetId) {
                            router.push(`/biblioteca/clases-individuales/${targetId}`);
                          }
                        }}
                    ...
                    {nextClass ? (
                      <>
                        ...
                        <div className="flex flex-col gap-2">
                          <Link
                            href={`/biblioteca/modulo/${slug}/practice/${nextClass._id}`}
                            onClick={() => setVideoEnded(false)}
            ...
            <div className="flex-1 overflow-y-auto p-4 flex flex-col gap-6">
                ...
                <ul className="space-y-1">
                  {moduleClasses.map((c) => {
                    ...
                    return (
                      <li key={c._id}>
                        <Link
                          href={`/biblioteca/modulo/${slug}/practice/${c._id}`}
                          onClick={() => setSidebarOpen(false)}
              ...
              {previousClass && (
                <section className="mt-auto pt-4 border-t border-palette-stone/20">
                  <Link
                    href={`/biblioteca/modulo/${slug}/practice/${previousClass._id}`}
                    onClick={() => setSidebarOpen(false)}
