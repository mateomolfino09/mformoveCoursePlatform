                ...
                <div className="w-full max-w-md rounded-lg border border-palette-cream/25 bg-palette-ink/55 p-6 md:p-8">
                  <div className="space-y-6">
                    ...
                    {(evento.invitacionGrupoWhatsapp ||
                      ...
                      evento.programaTransformacional?.comunidad?.invitacionGrupoWhatsapp ||
                      evento.programaTransformacional?.comunidad?.grupoWhatsapp) && (
                      <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6">
                        <h4 className="font-bold text-white mb-3">Grupo de WhatsApp del evento</h4>
                        <p className="text-gray-200 text-sm mb-4">
                          Invitación al grupo de este evento (distinta del link general de la comunidad).
                        </p>
                        <a
                          href={
                            evento.invitacionGrupoWhatsapp ||
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="inline-flex w-full justify-center rounded-full border-2 border-[#25D366] px-6 py-3 font-montserrat text-sm font-semibold uppercase tracking-[0.12em] text-white transition-opacity hover:opacity-90"
