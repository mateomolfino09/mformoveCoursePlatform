      ...
      <div className="min-h-screen bg-palette-cream flex flex-col items-center justify-center px-6 py-16 font-montserrat">
        <div className="w-full max-w-md rounded-2xl border border-palette-stone/25 bg-white/60 backdrop-blur-sm p-8 text-center shadow-[0_4px_24px_rgba(20,20,17,0.06)]">
          ...
          <button
            ...
            className="mt-6 w-full font-montserrat font-semibold text-sm uppercase tracking-[0.2em] rounded-full px-6 py-3 bg-palette-ink text-palette-cream border-2 border-palette-ink hover:bg-palette-steel hover:border-palette-steel hover:text-palette-ink transition-all duration-200"
          >
            Reintentar
          </button>
        </div>
