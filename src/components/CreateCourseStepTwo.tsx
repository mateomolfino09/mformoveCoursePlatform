...
const CreateCourseStepTwo = ({ step2ToStep1, createCourse }: Props) => {
  ...
  const [courseType, setCourseType] = useState<string | null>(courseTypeReg);
  ...
  const handleSetQuestions = (quest: any) => {
    const arr = Array(Object.keys(quest).length)
      .fill(0)
          ...
          <div className='space-y-8'>
            <label className='flex flex-col space-y-3 w-full'>
              <h3 className='mb-5 text-lg font-medium text-gray-900 dark:text-white'>
                Define el tipo de curso que quieres crear
              </h3>
                  ...
                  >
                    <div className='block'>
                      <svg
                        ...
                        strokeWidth='1.5'
                        stroke='currentColor'
                        className='mb-2 text-gray-400 w-7 h-7'
                      >
                        <path
                      ...
                      <div className='w-full text-sm'>
                        Curso sin prueba final y diploma.
                      </div>
                    </div>
                  </label>
                </li>
                <li>
                  ...
                  >
                    <div className='block'>
                      ...
                      <div className='w-full text-sm'>
                        Curso sin prueba final con diploma.
                      </div>
                    </div>
                  </label>
                </li>
                <li>
                  ...
                  >
                    <div className='block'>
                      ...
                      <div className='w-full text-sm'>
                        Curso con prueba final y diploma.
                      </div>
                    </div>
                  </label>
                </li>
