...
const onSubmit = async (data: any) => {
  ...
  return (
    <div className='bg-white w-full h-auto md:h-72 flex flex-col md:flex-row justify-start md:justify-around scrollbar-hide space-x-12 md:space-x-2 overflow-hidden relative bottom-0'>
        <div className='text-black md:max-w-[33%] md:h-full flex flex-row space-x-6 pt-12 !mx-0 overflow-x-hidden px-8 md:px-0 md:items-start md:justify-center md:pl-8 relative md:top-12'>
