...
const Timer2 = () => {
  ...
  return (
      <div className="mx-3 mt-12 sm:p-10 p-4 rounded-md flex justify-center flex-col gap-6 shadow-[5px_5px_50px_rgba(47,46,60,1)] font-montserrat">
        <div className="flex flex-col gap-2">
          <h1 className="text-center sm:text-xl text-lg font-semibold leading-8 text-[#141414]">
