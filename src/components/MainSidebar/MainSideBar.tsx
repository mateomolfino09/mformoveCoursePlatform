...
const MainSideBar = ({ children, where }: Props) => {  
  ...
  return (
    <div className={`absolute w-full h-full`}>
      ...
      {(path == routes.navegation.index  || path == routes.navegation.eventos || path == routes.user.login || path == routes.user.forgetEmail || path == routes.user.forget || path == routes.user.register || path.includes(routes.navegation.payments)) && ( 
