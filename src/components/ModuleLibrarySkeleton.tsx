    ...
    <FilterNavWrapper>
      <div className="relative bg-palette-ink min-h-screen overflow-x-hidden font-montserrat">
        <MainSideBar where="library">
          <main className="relative pt-28 md:pt-32 lg:pt-36 pb-20">
            <div className="max-w-7xl px-6 md:px-12 lg:px-16 xl:px-24 2xl:px-32">
              ...
              <SkeletonLine className="h-9 w-56 md:w-72 mb-6 lg:mb-8" />
