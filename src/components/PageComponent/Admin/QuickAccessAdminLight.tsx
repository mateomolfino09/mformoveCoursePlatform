                ...
                <Link href={feature.href}>
                  <div className="relative p-4 rounded-lg bg-white border border-gray-200 hover:border-[#4F7CCF]/50 transition-all cursor-pointer group hover:shadow-md">
                    <div className="flex items-center gap-3 mb-2">
                      <motion.div
                        className={`p-2 rounded-lg bg-gradient-to-br ${feature.color} shadow-md group-hover:shadow-lg transition-shadow`}
                      >
                    ...
                    <p className="text-xs text-gray-600 font-montserrat">{feature.description}</p>
                  </div>
                </Link>
              </motion.div>
            );
                ...
                >
                  {isDisabled ? (
                    <div className="relative p-4 rounded-lg bg-gray-50 border border-gray-200 cursor-not-allowed opacity-50">
                      ...
                      <h4 className="text-sm font-light text-gray-400 font-montserrat mb-1">{feature.name}</h4>
                      <p className="text-xs text-gray-500 font-montserrat">{feature.description}</p>
                    </div>
                  ) : (
                    <Link href={feature.href}>
                      <motion.div className="relative p-4 rounded-lg bg-gradient-to-br from-amber-50/50 via-white to-orange-50/30 border border-amber-200/40 hover:border-amber-300/60 transition-all cursor-pointer group hover:shadow-md">
                        <div className="flex items-center gap-3 mb-2">
                          <motion.div
                            className={`p-2 rounded-lg bg-gradient-to-br ${feature.color} shadow-md group-hover:shadow-lg transition-shadow`}
                          >
...
export default QuickAccessAdminLight;
