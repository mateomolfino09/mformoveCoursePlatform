...
const CreatePromocion = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      const url = endpoints?.payments?.promocion?.create 
        ? endpoints.payments.promocion.create
        : '/api/payments/promocion/create';
  ...
  return (
    <AdmimDashboardLayout>
      <Head>
        ...
        <meta name='description' content='Crear nueva promoción' />
