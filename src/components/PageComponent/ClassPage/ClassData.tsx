...
const ClassData = ({
  ...
  return (
    <div className='w-full h-full flex flex-col mt-8 lg:pb-8 justify-between bg-dark lg:w-2/3 md:h-auto '>
      ...
      <div className='mt-4 min-w-[5rem] space-x-4 px-2 flex flex-row mr-4 rounded-lg'>
        {clase?.tags.map(tag => (
          <>
            <div key={tag.id} className='bg-white cursor-pointer transition-all duration-300 hover:scale-105 w-auto px-2 py-1 flex justify-center items-center rounded-full'>
