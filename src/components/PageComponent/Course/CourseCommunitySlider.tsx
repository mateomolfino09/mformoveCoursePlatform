...
const CourseCommunitySlider = () => {
  ...
  return (
    <section className="relative isolate overflow-hidden py-12 md:py-14 bg-palette-cream font-montserrat">
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_70%_0%,rgba(172,174,137,0.18),transparent_55%)]" aria-hidden />
      <div className="relative w-[85%] max-w-6xl mx-auto px-4 text-center">
        ...
        <div className="relative">
          ...
          <button
            ...
            className="absolute left-2 md:left-4 top-1/2 -translate-y-1/2 z-10 bg-palette-cream/95 hover:bg-palette-steel/30 text-palette-steel p-2 md:p-3 rounded-full shadow-lg border border-palette-steel/45 transition-all duration-300 hover:text-palette-ink hover:scale-110"
          ...
          <button
            onClick={goToNext}
            className="absolute right-2 md:right-4 top-1/2 -translate-y-1/2 z-10 bg-palette-cream/95 hover:bg-palette-steel/30 text-palette-steel p-2 md:p-3 rounded-full shadow-lg border border-palette-steel/45 transition-all duration-300 hover:text-palette-ink hover:scale-110"
...
export default CourseCommunitySlider;
