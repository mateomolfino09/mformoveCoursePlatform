...
interface CourseFeaturesNavProps {
          ...
          <div
            className={`relative flex items-center justify-center gap-2 px-4 py-2 rounded-full min-w-[190px] h-12 transition-all cursor-pointer shadow-md hover:shadow-lg ${
              isDisabled || isLocked
                ...
                ? 'bg-palette-steel/22 backdrop-blur-md border border-palette-steel/42 hover:bg-palette-steel/42 hover:border-palette-steel/70 hover:[&_span]:text-palette-ink [&_span]:transition-colors [&_span]:duration-200'
                : canAccess
...
export default CourseFeaturesNav;
