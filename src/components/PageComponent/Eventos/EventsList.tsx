            ...
            {eventosFiltrados.length >= 6 && (
              <div className="text-center pt-8">
                <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-gray-100 to-gray-50 px-6 py-3 rounded-full border border-gray-200">
                  ...
                  <a href={MENTORSHIP_APPLY_CTA.href} className="text-[#234C8C] font-semibold font-montserrat hover:text-[#1a3d73] transition-colors">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                >
                  <span>{MENTORSHIP_LANDING_CTA.label}</span>
                </a>
              </div>
            </div>
