...
const ProgramaTransformacionalInfo: React.FC<Props> = ({ evento }) => {
  ...
  const invitacionGrupo =
    evento.invitacionGrupoWhatsapp ||
    evento.grupoWhatsapp ||
    comunidad.invitacionGrupoWhatsapp ||
  ...
  return (
    <section className="py-20 px-4 bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        >
          {/* Animal decorativo sutil de fondo */}
          <div className="absolute -top-8 left-1/2 -translate-x-1/2 w-40 h-40 md:w-64 md:h-64 opacity-3 pointer-events-none">
            <img 
          ...
          <div className="inline-flex items-center px-4 py-2 bg-black/5 text-black rounded-full text-sm font-light mb-6 relative z-10">
        ...
        >
          <div className="bg-gray-900/5 rounded-2xl p-6 border border-black/10 text-center">
            ...
            <div className="text-2xl font-light text-gray-900">{programa.duracionSemanas}</div>
          ...
          <div className="bg-gray-900/5 rounded-2xl p-6 border border-black/10 text-center">
            ...
            <div className="text-2xl font-light text-gray-900">{sesionesEnVivo.length}</div>
          ...
          <div className="bg-gray-900/5 rounded-2xl p-6 border border-black/10 text-center">
            ...
            <div className="text-2xl font-light text-gray-900">Certificado</div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {semanas.map((semana, index) => (
              ...
              >
                ...
                <h4 className="font-light text-gray-900 mb-2">{semana.titulo}</h4>
                <p className="text-gray-600 text-sm mb-4">{semana.descripcion}</p>
                
                {semana.contenido && semana.contenido.length > 0 && (
                    <div className="space-y-2">
                    <div className="text-xs font-light text-gray-500">Contenido:</div>
                    {semana.contenido.slice(0, 3).map((item, idx) => (
                      <div key={idx} className="flex items-center text-xs text-gray-600">
                        <CheckIcon className="w-3 h-3 text-black/60 mr-2" />
                        {item.titulo}
                      </div>
                    ))}
              ...
              {sesionesEnVivo.map((sesion, index) => (
                ...
                >
                  <div className="flex items-center mb-4">
                    ...
                    <div>
                      <div className="font-light text-gray-900">Sesión {index + 1}</div>
                  ...
                  <h4 className="font-light text-gray-900 mb-2">{sesion.titulo}</h4>
          ...
          >
            <div className="grid lg:grid-cols-2 gap-8 items-center">
                  ...
                  {invitacionGrupo && (
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <div className="text-gray-300 text-sm">Comparte experiencias y logros</div>
                      </div>
                    </div>
                  )}
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6">
                <h4 className="text-xl font-light mb-4">¿Por qué 8 semanas?</h4>
                <div className="space-y-3">
                  <div className="flex items-start">
                    <CheckIcon className="w-5 h-5 text-white/60 mr-3 mt-0.5" />
