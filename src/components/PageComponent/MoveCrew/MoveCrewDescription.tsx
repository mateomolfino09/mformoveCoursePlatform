...
const paragraphs = [
  ...
  'Por eso creé la Move Crew. La práctica de la práctica. Volver al origen para recuperar esa capacidad de adaptarnos y explorar; es entonces cuando surge la aceptación y crecemos.'
];
