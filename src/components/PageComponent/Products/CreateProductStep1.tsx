           ...
           {tipo === 'curso' && (
             <div className='border-b border-gray-200 pb-6 space-y-6'>
               ...
               <p className='text-sm text-gray-600 mb-4'>
                 Configurá textos, videos, testimonios, sellos, preguntas frecuentes y CTAs. En módulos podés subir el PDF de cada clase a Cloudinary. En Recursos adicionales sumás clases o archivos para la biblioteca. Los links de pago se generan al crear el producto.
               </p>
