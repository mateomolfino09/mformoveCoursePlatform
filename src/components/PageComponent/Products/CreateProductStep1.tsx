           ...
           {tipo === 'curso' && (
             <div className='border-b border-gray-200 pb-6 space-y-6'>
               ...
               <p className='text-sm text-gray-600 mb-4'>
                 Configurá textos, videos, testimonios, sellos de validación, Preguntas frecuentes y CTAs de la página comercial. Los links de pago se generan al crear el producto.
               </p>
