...
const ProductCard = ({ product }: Props) => {
  return (
  <div className="max-w-4xl h-96 md:h-[28rem] font-montserrat flex flex-col bg-white border border-gray-200 rounded-xl shadow dark:bg-light-cream dark:border-gray-700">
    ...
    <div className='h-96 relative'>
      <a href="#">
        <CldImage preserveTransformations layout='fill'
