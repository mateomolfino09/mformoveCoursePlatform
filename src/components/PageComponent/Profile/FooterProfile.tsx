    ...
    <div className='bg-soft-black w-full h-auto md:h-72 flex flex-col md:flex-row justify-start md:justify-between scrollbar-hide space-x-12 overflow-hidden relative bottom-0'>
      <div className='text-white flex flex-col md:flex-col pt-12 pl-8 '>
        ...
        <p className='text-xs md:text-sm'>
          Subscribete hoy para todas las actualizaciones y promociones
        </p>
      </div>
      <div className='text-white flex flex-col space-y-12 pt-12 !mx-0 px-6 overflow-x-hidden'>
        <div className='flex w-full flex-col md:pl-0 space-y-4 md:space-y-0 md:flex-row md:space-x-5'>
          ...
          >
            <Link href={'/'}>
              <h4 className='font-light text-sm md:text-base w-full md:text-center'>
                Home
              </h4>
            </Link>
          </div>
          ...
          <div
            style={{ flex: '1 1 0px;' }}
            className='cursor-pointer md:w-1/3 w-full'
          >
            <Link href={'/select-plan'}>
              <h4 className='font-light text-sm md:text-base md:text-center'>
                Memberships
              </h4>
            </Link>
          </div>
          ...
          {auth.user ? (
            <div style={{ flex: '1 1 0px;' }} className='md:w-1/3 w-full'>
              <Link href={'/account'}>
                <h4 className='font-light text-sm md:text-base md:text-center cursor-pointer'>
                  Mi Cuenta
                </h4>
              </Link>
            </div>
      ...
      <div className='text-white flex items-start justify-start flex-col md:pl-0 space-y-2 !mx-6 mb-8 mt-12 md:pt-12 md:pr-4 overflow-x-hidden'>
        <p className='text-xs font-light md:mb-2 hover:underline focus:underline cursor-pointer'>
