...
const virtualClassSchema = new mongoose.Schema(
  {
    ...
    platform: {
      type: String,
      required: true,
      enum: ['Zoom', 'Google Meet', 'Microsoft Teams', 'Otro']
    },
    meetingLink: {
      type: String,
      required: true
...
virtualClassSchema.index({ active: 1, 'schedules.dayOfWeek': 1 });

let Dataset = mongoose.models.VirtualClass || mongoose.model('VirtualClass', virtualClassSchema);
